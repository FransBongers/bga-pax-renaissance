...
class PREN140X_VenetianNavy extends \PaxRenaissance\Models\TableauCard
{
  public function __construct($row)
  {
    ...
    $this->flavorText = [
      ...
      clienttranslate("His brother, Pietro Mocenigo, was also a doge of Venice but also was one of the greatest Venetian admirals, who saw action in Smurna, Cyprus, and Scutari."),
    ];
