...
class PREN020_ArumerZwarteHoop extends \PaxRenaissance\Models\TableauCard
{
  public function __construct($row)
  {
    ...
    $this->empire = FRANCE;
    $this->flavorText = [
      clienttranslate('When the Black Band (imperial troops) conquered free Frisia, they raped and killed the wife of Pier Gerlofs Donia. This man, known as "Grutte Pier" (Great Pier) because of his superhuman size and strength, led peasant guerillas on a rampage from 1515-20.'),
