...
class PREN123X_NothingNew extends \PaxRenaissance\Models\TableauCard
{
  public function __construct($row)
  {
    ...
    $this->empire = HUNGARY;
    $this->flavorText = [
      clienttranslate('In 1505 the "Nihil Novi" (latin for "nothing new") act was passed, meaning the Polish king was not allowed to issue new laws without permission from the Sejm, represented by the upper and lower nobled.'),
