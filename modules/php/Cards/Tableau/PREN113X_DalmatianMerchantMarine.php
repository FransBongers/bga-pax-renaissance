...
class PREN113X_DalmatianMerchantMarine extends \PaxRenaissance\Models\Cards\ConcessionsCannotBeKilledByPiratesCard
{
  public function __construct($row)
  {
    ...
    $this->flavorText = [
      ...
      clienttranslate("In 1458 it became a vassal of the Ottomans, with an annual payment of 12,500 ducats to the sultan. In return the Ragusan ships were allowed access to the Black Sea, denied to other foreign merchants, and received special tax exemptions and trading benegfits from the Porte.")
    ];
