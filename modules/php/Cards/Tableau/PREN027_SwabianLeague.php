...
class PREN027_SwabianLeague extends \PaxRenaissance\Models\TableauCard
{
  public function __construct($row)
  {
    ...
    $this->flavorText = [
      ...
      clienttranslate("The League's Landsknechte fought expansionist Bavarian dukes, Kempton and Swiss peasants rebelling against feudal duties (1491,1499), and the Bundschuh Uprising of 1524-1525. The League was disbanded by the Reformation.")
    ];
