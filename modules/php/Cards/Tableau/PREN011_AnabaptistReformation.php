...
class PREN011_AnabaptistReformation extends \PaxRenaissance\Models\TableauCard
{
  public function __construct($row)
  {
    ...
    $this->flavorText = [
      ...
      clienttranslate('The painting commemorates an Anabaptist martyr, who while escaping from prison, stopped to save the life of a pursuer, and so was recaptured and burned at the stake.')
    ];
