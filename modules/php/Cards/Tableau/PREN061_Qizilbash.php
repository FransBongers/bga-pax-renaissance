...
class PREN061_Qizilbash extends \PaxRenaissance\Models\TableauCard
{
  public function __construct($row)
  {
    ...
    $this->empire = EAST;
    $this->flavorText = [
      clienttranslate("The warlord Ismail I conquered Persia in 1501, declaring himself Shah of Azerbaijan and Iran. His Qizilbāsh followers declared him to be of devine Shi'i birth, and the various Sufi orders followed suit."),
