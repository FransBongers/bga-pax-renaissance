...
class PurchaseCard extends \PaxRenaissance\Models\AtomicAction
{
  ...
  public function argsPurchaseCard()
  {
  ...
  public function actPurchaseCard($cardId, $strength)
  {
    self::checkAction('actPurchaseCard');
    $player = Players::getActive();
  ...
  {
    Notifications::log('stPurchaseCard',$this->ctx->getArgs());
